...
void Function()
{
  u8 a;
	...
	switch(a)
	{
	  case 0x01:pid.Sv++;break;
		case 0x02:pid.Sv--;break;
	  case 0x03:pid.T+=50;break;
		case 0x04:pid.T-=50;break;
		case 0x05:pid.Ti+=1000;break;
		case 0x06:pid.Ti-=1000;break;
		case 0x07:pid.Td+=100;break;
		case 0x08:pid.Td-=100;break;
		case 0x09:pid.Kp++;break;
		case 0x0a:pid.Kp--;break;
		case 0x0b:pid.pwm_T+=10;break;
		case 0x0c:pid.pwm_T-=10;break;
